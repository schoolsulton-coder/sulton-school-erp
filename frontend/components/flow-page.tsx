...
import { Plus, ArrowDownLeft, ArrowUpRight, Scale, ListOrdered, Repeat2, Copy } from 'lucide-react';
  ...
  return (
    <div className="min-h-full bg-slate-50/60 p-6">
      ...
      <div className="mb-5 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard tone="violet" label="Sof oqim" value={money(totals.net)} icon={Scale} />
        <StatCard tone="amber" label="Jami operatsiyalar" value={`${totals.count} ta`} icon={ListOrdered} />
      </div>

      {/* Operatsiyalar */}
      <div className="mb-5">
        <Panel title="Pul oqimi operatsiyalari" hint="Har bir yozuv ikki hisob bo'yicha qayd etiladi">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <Panel title="Hisoblar balansi">
          {accounts?.length ? (
            ...
            <p className="px-5 py-8 text-center text-sm text-slate-400">Hisob yo&apos;q</p>
          )}
        </Panel>
