...
export default function HomeworkDetailPage() {
  ...
  if (!hw) return <div className="p-8 text-slate-400">Vazifa topilmadi</div>;
            ...
            {sub.files.map((raw, i) => {
              ...
              return (
                <a key={i} href={href} download={name} target="_blank" rel="noopener"
                  className="inline-flex items-center gap-1 rounded border border-slate-200 px-1.5 py-0.5 text-xs text-brand hover:bg-slate-50">
